...
const ActualizarPermiso = () => {
    ...
    const [valuePermiso, setValuePermiso] = useState(null);
    const [inputValuePermiso, setInputValuePermiso] = useState('');
    ...
    const actualizarPermiso = () => {
        if (inputValuePermiso === '' || nombrePermiso === '') {
            toast.warning('Todos los campos son obligatorios', { theme: "dark", position: "top-center", toastId: 'warning1' });
        } else {
            const url = 'http://localhost/backend-usabilidad-main/userServices/permisos/actualizarPermiso.php';
            ...
            <div className="container">
                ...
                <div className="row | mb-2 | mt-2">
                    <div className="col-12 | col-md-4 | col-sm-12">
                        <label>Actualizar Permiso</label>
                    </div>
                </div>
                ...
                <div className="row | mb-4 | pt-4">
                    <div className="col-12 | col-md-6 | col-sm-12">
                        <Autocomplete
                            ...
                            inputValue={inputValuePermiso}
                            onInputChange={(_, v) => setInputValuePermiso(v)}
                ...
                <div className="row | mb-4">
                    <div className="col-12 | col-md-6 | col-sm-12">
                        <TextField fullWidth onChange={(v) => { setNombrePermiso(v.target.value); }} id="outlined-basic" label="Nombre Actualizado" variant="outlined" />
                    </div>
                </div>

                <div className="row">
                    <div className="col-12 | col-md-6 | col-sm-12">
                        <Button onClick={actualizarPermiso} color="primary" variant="contained">Actualizar Permiso</Button>
                    </div>
                </div>
            </div>
        </Fragment>
